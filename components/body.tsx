...
//     // width={600}
//     // height={800}
//     sizes="(max-width: 768px) 100vw, 50vw" // Adjusts image size based on viewport
//     style={{ width: "100%", height: "auto" }} // Ensures responsiveness
//  className="rounded-2xl shadow-lg object-contain transform hover:scale-105 transition-transform duration-300"
//   />
// </div>;
